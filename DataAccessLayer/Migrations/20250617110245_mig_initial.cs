    ...
    public partial class miginitial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    StoreSettingID = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_StoreSettings", x => x.StoreSettingID);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_VendorProducts_ProductVendors_ProductVendorID",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_VendorProducts_ProductVendorID",
                table: "VendorProducts",
